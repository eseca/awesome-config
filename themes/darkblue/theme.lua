...
-- {{{ Main
theme = {}
theme.wallpaper_cmd = {"awsetbg -a -r " .. awful.util.getdir("config") .. "/themes/darkblue/wallpapers/"}
-- }}}
...
theme.layout_floating   = awful.util.getdir("config") .. "/themes/darkblue/layouts/floating.png"
-- }}}
return theme
